...
class Booking(models.Model):
    ...
    One-to-many: One listing can have many bookings; one user can have many bookings.
    """
    STATUS_CHOICES = [
        ('pending', 'Pending'),
        ('confirmed', 'Confirmed'),
...
class Review(models.Model):
    ...
    One-to-many: One listing can have many reviews; one user can have many reviews.
    """
